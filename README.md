...
|------------|------------|------|------------|------|
| Project | STT 자동 변환 프로그램 | 음성 데이터를 텍스트로 변환하고, 편집하는 프로그램 | Python | [🔗 바로가기](./Project%2001.%20STT%20자동%20변환%20프로그램/README.md) |
| Project | 센서 기반 자동 제어 프로그램 | 변위, 온도 등 다양한 센서를 통합 제어하고 시각화하는 검사 제어  프로그램 | C# | [🔗 바로가기](./Project%2002.%20센서%20기반%20자동%20제어%20프로그램/README.md) |
| Project | 비전 카메라와 로봇 간 통신 연동 API 개 | 서로 다은 통신 언어를 자동 변환하는 양방향 API 개 | Python | [🔗 바로가기](./Project%2003.%20비전%20카메라와%20로봇%20간%20통신%20연동%20API%20개발/README.md) |
